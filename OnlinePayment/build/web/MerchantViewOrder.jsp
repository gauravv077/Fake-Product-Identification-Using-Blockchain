<%-- 
    Document   : MerchantViewOrder
    Created on : 26 May, 2016, 11:14:16 PM
    Author     : Dell
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="clearfix"></div>
            <form name="order" action="merchantupdateorder">
                    ...
                    <center>     
                        <div id="welcome" class="post">
                            ...
                            <%
                                ...
                                Statement st = db.st;
                                String items = "";
                                String order_id = request.getQueryString();

                                ResultSet rs = st.executeQuery("select * from orders where orderid='" + order_id + "'");
                                while (rs.next()) {
                            ...
                            <center>
                                ...
                                <table border="3">
                                     <tr>
                                        ...
                                        <td>
                                            <input id="orderid" name="orderid" value="<%=order_id%>" readonly>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input id="txtamount" name="txtamount" value="<%=total%>" readonly>
                                        </td>
