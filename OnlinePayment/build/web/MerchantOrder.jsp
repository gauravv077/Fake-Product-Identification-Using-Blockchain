<%-- 
    Document   : MerchantOrder
    Created on : 26 May, 2016, 10:21:28 PM
    Author     : Dell
--%>
                        ...
                        <div id="welcome" class="post">
                            ...
                            <table border="3">
                                ...
                                <%
                                    ...
                                    Statement st = db.st;
                                    ResultSet rs = st.executeQuery("select  a.orderid,a.date_,a.status,a.amount, b.email  from orders a, orderformurchats b where a.orderid=b.orderid and a.status!='Received' and b.email='"+mail+"'");
                                    while (rs.next()) {
                                %>
                                <tr>
                                    <td width="100px"><%=rs.getString("orderid")%></td>
                                    <td width="100px"><%=rs.getString("date_")%></td>
                                    <td width="100px"><%=rs.getString("amount")%></td>
                                    <td width="100px"><%=rs.getString("status")%></td>
                                    <td width="100px"><a href="MerchantViewOrder.jsp?<%=rs.getString("orderid")%>">View Details</a></td>
                                </tr>
                                <%
                                    }
                                %>
