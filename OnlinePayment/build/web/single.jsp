<%-- 
    Document   : single
    Created on : 4 May, 2016, 8:03:33 PM
    Author     : Dell
--%>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav menu__list">
                                    ...
                                    <li class=" menu__item"><a class="menu__link" href="orserstatus.jsp">OrderStatus</a></li>
            ...
            <div class="container">
                ...
                <div class="col-md-6 single-right-left simpleCart_shelfItem animated wow slideInRight animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: slideInRight;">
                    ...
                    <div class="description">
                        ...
                        <form action="#" onsubmit=" return onChek()">
                            <input type="text" placeholder="Enter pincode" name="pincode" maxlength="6"  id="pin" pattern="^[0-9]{4}$" required/>
