...
<html>
    ...
    <body>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse menu--shylock" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav menu__list">
                                    ...
                                    <li class=" active menu__item menu__item--current"><a class="menu__link" href="AddWomens.jsp">Add Womens Wear</a></li>
        ...
        <div class="checkout" style="padding:20px 0;">
            <center>    
                <input class="hvr-outline-out button2" data-toggle="modal" data-target="#myModal4" type="submit" value=" Add Item ">
                <br><br>
            </center>
            <div class="container">
                <div class="table-responsive checkout-right animated wow slideInUp" data-wow-delay=".5s" style="height: 300px">
                    <table class="timetable_sub" style="overflow: scroll">
                        ...
                        <%
                            ...
                            Statement st = db.st;
                            ResultSet rs = st.executeQuery("select * from items where cat='Womens Wear'");
                            while (rs.next()) {
                                int id = rs.getInt("id");
                                ...
                                String tags = rs.getString("tags");
                                 String encryptedID=AES.encrypt(String.valueOf(id));

                        %>
                        <tr class="rem1">
                            <td class="invert-closeb" style="width: 20px">

                                <a href="RemoveServlet?id=<%=id%>"> Delete </a>

                            </td>
                            <td class="invert-image" style="width:15%;"><a href="#"><img src="images/<%=image%>" alt=" " class="img-responsive" /></a></td>
                             <td class="invert-image" style="width:25%;"><a href="#"><img src="GenerateQR?id=<%=encryptedID%>" alt=" " class="img-responsive" /></a></td>
                            ...
                            <td class="invert" style="width: 10px"><%=tags%></td>
                        </tr>
                        <%}%>
                    </table>
                    <br>
                ...
                <div class="modal-content modal-info">
                    ...
                    <div class="modal-body modal-spa">
                        <div class="login-grids">
                            <div class="login">
                                <form action="addwomens" method="post" enctype="multipart/form-data">
