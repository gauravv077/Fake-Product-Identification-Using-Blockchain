<%-- 
    Document   : womens
    Created on : 4 May, 2016, 3:25:31 PM
    Author     : Dell
--%>
                    ...
                    <%
                        try {
                            ...
                            if (cat.equals("") || cat.equals("null")) {
                                rs = st.executeQuery("select * from items where cat='Womens Wear'");
                            } else {
                                rs = st.executeQuery("select * from items where cat='Womens Wear' and subcat='" + cat + "'");
                            }
                            while (rs.next()) {
                    ...
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="images/<%=image%>" height="290px" width="100px" alt="" class="pro-image-front">
