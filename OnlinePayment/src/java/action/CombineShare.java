 ...
 * @author admin
 */
@WebServlet(name = "CombineShare", urlPatterns = {"/CombineShare"})
public class CombineShare extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            String uname=sn.getAttribute("UserPass").toString();
            
            ServletContext sc = this.getServletContext();
            String sg=sc.getRealPath("/");
            String path=sg.substring(0,sg.indexOf("build"));
            //String fp=path+"web\\image\\"+uname;
           // String share0=sn.getAttribute("share0").toString();
            String sh1=path+"web\\shares\\"+uname+"sh0.jpg";
            String sh2=path+"web\\shares\\"+uname+"sh1.jpg";
            ...
            String fp=path+"web\\shares\\"+uname;
