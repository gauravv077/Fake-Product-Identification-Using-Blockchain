        ...
        <div class="header-bot">
            <div class="container">
                ...
                <div class="col-md-3 header-right footer-bottom">
                    <ul>
                        <li><a href="#" class="use1" data-toggle="modal" <%if(email.equals("Login")){%>data-target="#myModal3"<%}%>><span><%=email%></span></a>
                    ...
                    <%
                        try {
                            ...
                            if (cat.equals("") || cat.equals("null")) {
                                rs = st.executeQuery("select * from items where cat='Electronics'");
                            } else {
                                rs = st.executeQuery("select * from items where cat='Electronics' and subcat='" + cat + "'");
                            }
                            while (rs.next()) {
                    ...
                    <div class="col-md-3 product-men">
                        <div class="men-pro-item simpleCart_shelfItem">
                            <div class="men-thumb-item">
                                <img src="images/<%=image%>" height="350px" width="150px" alt="" class="pro-image-front">
                                ...
                                <div class="login-right" style="float: left; width: 100%">
                                    ...
                                    <form action="logincheck">
                                        ...
                                        <div class="sign-in">
                                            ...
                                            <a href="#">Forgot password?</a>&nbsp;&nbsp; &nbsp;&nbsp;  <a href="#" data-toggle="modal" data-target="#myModal4">New User?</a>
                                        </div>
                            ...
                            <div class="login">
                                <div class="login-bottom">
                                    ...
                                    <form>
                                        ...
                                        <div class="sign-up">
                                            <h4>Name</h4>
                                            <input type="text" value="Full Name" name="fname" onfocus="this.value = '';" onblur="if (this.value == '') {
