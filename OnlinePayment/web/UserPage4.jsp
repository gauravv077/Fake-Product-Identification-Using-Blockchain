...
<html>
    ...
    <body>
        ...
        <%
            ...
            String img1 = pass + "cs.jpg";
            if (sn.getAttribute("Result") != null) {
                out.println("<script>alert('Invalid password')</script>");
                sn.removeAttribute("Result");
            }
                ...
                <div id="page" style="height: 300px">
                    <center>     
                        <div id="welcome" class="post">
                            <br>
                            <br>
                            <img src="shares/<%= img1%>" width="150" height="50"> <br><br>

                            Enter Password <input type="text" id="shpass" name="shpass">
