<%-- 
    Document   : CardNumber
    Created on : 31 May, 2016, 12:10:07 AM
    Author     : Dell
./SetPassword
--%>
...
<html>
    <head>
        ...
        <script>
            function Validation()
            {
            var card=document.addreg.cardnuber.value;
            if (isNaN(card)) {
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="clearfix"></div>
            <form name="addreg" action="./SetPassword" onsubmit="return Validation();">
                ...
                <div id="page" style="height: 300px">
                    <center>     
                        <div id="welcome" class="post">
                            ...
                            <br><br>
                            Please enter pin Details<br><br>
                            <table cellpadding="3" cellspacing="3">                             
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="password" id="holdername" name="holdername">
                                    </td>
                                </tr>
                      
                            </table>
                            <br>
                            <input type="submit" value="Download Share">
